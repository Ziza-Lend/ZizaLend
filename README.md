...
ZizaLend treats remittance history as credit history. Migrant workers prove their financial reliability through monthly cross-border transfers, allowing them to receive fair loans without predatory fees. In return, lenders earn transparent yield powered by the Stellar network.
...
ZizaLend supports real-time event notifications via webhooks. See the
...
3. **Configure environment:**
   ...
   DATABASE_URL=postgres://postgres:postgres@localhost:5432/ZizaLend
   ```
