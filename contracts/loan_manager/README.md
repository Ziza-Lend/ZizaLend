...
- **CEI pattern**: Loan status committed to storage *before* any cross-contract token transfer, preventing reentrancy.
...
5. **Late fee base**: Fees on *original* principal, not remaining balance.
