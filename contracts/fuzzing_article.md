...
**Foundry** is a domain-specific tool. It _understands_ the EVM. It knows how to manage state, mock addresses, and interpret revert strings out of the box.
...
_Are you building on Soroban? Check out [soroban-sdk](https://github.com/stellar/soroban-sdk) and start your first fuzzing campaign today._
