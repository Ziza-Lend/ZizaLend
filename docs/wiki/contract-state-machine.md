...
This document details the state management and lifecycle of loans within the ZizaLend Soroban smart contracts.

## Overview

The core logic of ZizaLend resides in two primary contracts:
